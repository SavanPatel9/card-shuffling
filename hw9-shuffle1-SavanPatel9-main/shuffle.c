...
// program.
static void interleaveHelper(CardDeck leftDeck, CardDeck rightDeck, CardDeck destDeck, int leftInd, int rightInd, int newInd)
{
  ...
  interleaveHelper(leftDeck, rightDeck, destDeck, leftInd - 1, rightInd, newInd - 1);

  // pick one card from right deck
  destDeck.cards[newInd] = rightDeck.cards[rightInd];
  interleaveHelper(leftDeck, rightDeck, destDeck, leftInd, rightInd - 1, newInd - 1);
...
void interleave(CardDeck leftDeck, CardDeck rightDeck)
{
  ...
  interleaveHelper(leftDeck, rightDeck, destDeck, leftInd, rightInd, newInd);
